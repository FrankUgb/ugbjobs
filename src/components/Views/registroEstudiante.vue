<template>
    <div class="formulario-contenedor">
      ...
      <img src="../../../public/media/loginRegistroEstu/logoJobsUGB.png" alt="Logo UGB" style="display: block; margin: 0 auto;">
  ...
  export default {
    ...
    methods: {
      validarContrasena() {
        ...
        // Redirigir a la página principal después de la validación
        window.location.href = "home.html"; // Ajusta esto según tu estructura de rutas
      },
      actualizarCarreras() {
        const carreras = {
        ...
        this.opcionesCarreras = carreras[this.facultad] || [];
      }
    }
  };
  </script>
  ...
  <style scoped>
  /* Aquí puedes agregar los estilos desde tu CSS o crear nuevos estilos específicos para el componente */
  @import "../../../public/css/registroEstudiante.css";
  </style>
